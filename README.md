# Thermodynamic VLE Model: CO2-N2-Ethanol-Water System

A Python-based thermodynamic solver for Vapor-Liquid Equilibrium (VLE) modeling of the quaternary system: $CO_2 (1) - N_2 (2) - Ethanol (3) - Water (4)$. The custom model results have been rigorously validated against Aspen HYSYS.
...
8.  **Error Analysis:** The model accuracy is quantified using Absolute Relative Error (ARE):
